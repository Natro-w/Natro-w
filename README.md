<div align="center">
  ...
  <!-- INFECTED INTRO -->
  <div class="intro-box">
    <p><strong>MYSTERIOUS. DARK. PROFESSIONAL. FUTURISTIC. INFECTED.</strong></p>
    <p>🧠 <strong>MASTER OF GAMES, AUTOMATION, APIs, TOOLS — AND DIGITAL CHAOS.</strong></p>
    <p>💻 <strong>LANGUAGES: C# • C++ • JavaScript • Node.js • Python</strong></p>
    <p>🌌 <strong>MOTTO: “UPGRADING IRAQ.” — IN BLOOD CODE.</strong></p>
    <p>🔒 <strong>LOCATION: PRIVATE — BUT I SEE YOU.</strong></p>
  </div>
  ...
  <div class="project-card">
    <h4 style="margin:0 0 12px 0;">
      <a href="https://github.com/Natro-w/promag-steam-games" class="project-link">🩸 ProMag Steam Games</a>
    </h4>
  ...
  <blockquote class="motto-box">
    <p style="font-size:1.5em; margin:0 0 8px; font-weight:900;">
  ...
  <div class="warning-card">
    <p style="font-weight:900; font-size:1.4em; margin:0 0 12px;">
...
<style>
  ...
  .intro-box p { margin: 8px 0; color: #ff0000; }
  ...
  .project-link:hover { color: #ff3333; text-shadow: 0 0 15px #ff0000; }
  .feature-list {
    color: #ff3333;
    margin: 12px 0;
    padding-left: 28px;
  ...
  @media (max-width: 600px) {
    ...
    .intro-box, .project-card, .motto-box, .warning-card, .future-text { padding: 15px; font-size: 0.95em; }
    .badges-container, .stats-container { gap: 8px; }
  }
</style>
